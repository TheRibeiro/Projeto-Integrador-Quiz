...
public class JogoFinalPythonDificil extends javax.swing.JFrame {
    ...
    public void pergunta1() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 6 ";
    ...
    public void pergunta2() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 7 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta3() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 8 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta4() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 9 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta5() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 10 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    private void initComponents() {
        ...
        getContentPane().add(começarJogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 360, 350, 290));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 800, 260, 160));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Começar Python Dificil.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JogoFinalPythonDificil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JogoFinalPythonDificil().setVisible(true);
            }
        });
    }
