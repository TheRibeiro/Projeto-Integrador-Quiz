 ...
 * @author Windows
 */
public class JogoFinalPythonFacil extends javax.swing.JFrame {
    ...
    public void pergunta1() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Fácil\" and idQuestão = 1 ";
    ...
    public void pergunta2() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Fácil\" and idQuestão = 2 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta3() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Fácil\" and idQuestão = 3 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta4() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Fácil\" and idQuestão = 4 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta5() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Python\" and dificuldadeQuestão = \"Fácil\" and idQuestão = 5 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    private void initComponents() {
        ...
        getContentPane().add(começarJogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 380, 510, 330));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 820, 250, 140));

        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Começar Python.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JogoFinalPythonFacil.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JogoFinalPythonFacil().setVisible(true);
            }
        });
    }
