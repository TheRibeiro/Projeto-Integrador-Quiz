...
public class JogoFinalJavaDificil extends javax.swing.JFrame {
    ...
    public void pergunta1() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Java\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 16 ";
    ...
    public void pergunta2() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Java\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 17 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta3() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Java\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 18 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta4() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Java\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 19 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    public void pergunta5() {
        try {
            String sql = "Select idQuestão,tipoQuestão, perguntaQuestão, AlternativaCorreta, AlternativaA, AlternativaB, AlternativaC, AlternativaD, dificuldadeQuestão from Questõens where tipoQuestão = \"Java\" and dificuldadeQuestão = \"Dificil\" and idQuestão = 20 ";
            pst = conexao.prepareStatement(sql);
            rs = pst.executeQuery();
            if (rs.next()) {
                textoPergunta = (rs.getString(3));
    ...
    private void initComponents() {
        ...
        getContentPane().add(começarJogo, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 350, 420, 290));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 800, 290, 170));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/começar java dificil.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JogoFinalJavaDificil.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JogoFinalJavaDificil().setVisible(true);
            }
        });
    }
